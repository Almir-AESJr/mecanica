  ...
  <div class="height-10" id="conteudo">
    ...
    <div class="container">
      <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <select name="operacao" id="operacao" class="form-select">
                    <?php
                    $operacoes = listarOperacoes();
                    foreach ($operacoes as $operacao) {
                      echo "<option value='" . $operacao["operacao_id"] . "'>" . $operacao["descricao"] . "</option>";
                    }
                    ?>
                  </select>
        ...
        <!-- Gráfico da taxa de remoção -->
        <div id="div_ponto" class="col-md-12" style="height:400px;">
          <canvas id="grafico"></canvas>
        </div>

        <!-- Gráfico do Desgaste Relativo -->
        <div id="div_ponto_desgaste" class="col-md-12" style="height:400px;">
          <canvas id="graficoDesgaste"></canvas>
        </div>

        <!-- Gráfico do Rugosidade -->
        <div id="div_ponto_rugosidade" class="col-md-12" style="height:400px;">
          <canvas id="graficoRugosidade"></canvas>
        </div>
