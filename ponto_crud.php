    ...
    switch ($_POST["acao"]) {
        ...
        case 'grafico':
            try {
                ...
                if ($valor_relacao != "" && $valor_corrente != "") {
                    $sql = "select p.duracao, p.valor_remocao, p.eletrodo_id 
                         from ponto as p
        ...
        case 'graficoDesgaste':
            try {
                ...
                if ($valor_relacao != "" && $valor_corrente != "") {
                    $sql = "select p.duracao, p.valor_desgaste, p.eletrodo_id 
                             from ponto as p
                             where valor_corrente = ? and valor_relacao = ?";
                } elseif ($valor_corrente != "" && $valor_relacao == "") {
        ...
        case 'graficoRugosidade':
            try {
                ...
                if ($valor_relacao != "" && $valor_corrente != "") {
                    $sql = "select p.duracao, p.valor_rugosidade, p.eletrodo_id
                                 from ponto as p
                                 where valor_corrente = ? and valor_relacao = ?";
                } elseif ($valor_corrente != "" && $valor_relacao == "") {
...
{
    try {
        $sql = "select distinct(p.operacao_id), o.descricao
        from ponto p, operacao o
